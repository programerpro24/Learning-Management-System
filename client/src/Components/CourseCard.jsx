...
function CourseCard({data}) {
  ...
  return (
    <div onClick={()=>navigate('/course/description', {state:{...data}})} className="text-white w-[16rem] h-[27rem] shadow-lg rounded-lg cursor-pointer group overflow-hidden bg-zink-700">
